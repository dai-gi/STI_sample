...
class TrucksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create truck" do
    assert_difference("Truck.count") do
      post trucks_url, params: { truck: { name: @truck.name, number_of_seater: @truck.number_of_seater, size: @truck.size } }
    end
  ...
  test "should update truck" do
    patch truck_url(@truck), params: { truck: { name: @truck.name, number_of_seater: @truck.number_of_seater, size: @truck.size } }
